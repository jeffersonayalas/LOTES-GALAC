...
class VentanaPrincipal(QWidget):
    ...
    def enviar_datos(self):
            ...
            try:
                ...
                hilo_fusion = threading.Thread(target=api_data, args=(1,))
                hilo_fusion.start()
...
class VentanaArchivo(QMainWindow):
    ...
    def initUI(self):
        ...
        self.boton_archivo = QPushButton("Realizar Verificacion de Clientes", self)
        self.boton_archivo.clicked.connect(self.actualizar)
    ...
    def actualizar(self):
            ...
            hilo_actualizacion = threading.Thread(target=api_data, args=(0,))
